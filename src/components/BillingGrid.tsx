...
export default function BillingGrid({ clinicId, providerId, readOnly, visibleColumns, dateRange }: BillingGridProps) {
  ...
  const columnDefs: ColDef[] = useMemo(() => {
    const defs: Array<[string, ColDef]> = [
      ...
      ['procedure_code', { headerName: 'Procedure Code', editable: !readOnly }],
      ['description', { headerName: 'Description', editable: !readOnly }],
      ['amount', { headerName: 'Amount', editable: !readOnly, valueParser: numberParser }],
      ['date', { headerName: 'Date', editable: !readOnly }],
      ['status', { headerName: 'Claim Status', editable: !readOnly }],
      ['claim_number', { headerName: 'Claim #', editable: !readOnly }],
      ['notes', { headerName: 'Notes', editable: !readOnly }],
      ['appointment_status', { headerName: 'Appt Status', editable: !readOnly }],
      ['submit_info', { headerName: 'Submit Info', editable: !readOnly }],
      ['insurance_payment', { headerName: 'Ins. Payment', editable: !readOnly, valueParser: numberParser }],
      ['insurance_notes', { headerName: 'Ins. Notes', editable: !readOnly }],
      ['payment_amount', { headerName: 'Pt Payment', editable: !readOnly, valueParser: numberParser }],
      ['payment_status', { headerName: 'Pt Pay Status', editable: !readOnly }],
      ['month_tag', { headerName: 'Month', editable: !readOnly }]
    ];
